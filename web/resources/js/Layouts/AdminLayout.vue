    ...
    <div class="md:flex">
        ...
        >
            ...
            >
                ...
                >
                    <div>
                        <svg
                            class="h-8 w-8 transition-transform duration-300 group-hover:-rotate-45"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                        >
        ...
        <div class="flex-1 flex-col flex">
                ...
                <div class="mx-auto">
                    <div class="flex items-stretch justify-between h-16">
                        ...
                        <div class="flex items-center pl-6">
                            ...
                            <!-- toggel sidebar -->
                            <div
                                class="text-white cursor-pointer hidden md:block"
                                @click="$dispatch('togglesidebar')"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="hidden md:flex items-stretch">
                            ...
                            <div class="ml-4 flex md:ml-6">
                                <div
                                    class="relative flex justify-center items-center mr-4"
                                >
                                    <div
            ...
            <main class="bg-[#f3f3f9] mb-auto flex-grow">
                <div
                    class="border-b bg-white border-gray-300 pl-6 py-2 shadow-sm text-xl font-bold"
                >
                    TITLE GOES HERE
