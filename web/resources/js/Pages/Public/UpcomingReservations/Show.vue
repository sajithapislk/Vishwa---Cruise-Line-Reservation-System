        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="relative h-64 rounded-lg overflow-hidden">
                    <img
                        :src="route('ship.img', upcomingReservations.ship.img)"
                        class="w-full h-full object-cover"
                        alt="Ship Image"
                    />
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center">
                        <div class="w-1/2">
                            ...
                            <p class="font-medium">
                                {{ formatDate(upcomingReservations.depart_at) }}
                            </p>
                        ...
                        <div class="w-1/2">
                            ...
                            <p class="font-medium">
                                {{ formatDate(upcomingReservations.arrive_at) }}
                            </p>
                            <p class="text-sm text-gray-500">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="space-y-2">
                    ...
                    >
                        ...
                        <span
                            >${{
                                Number(upcomingReservations.price) +
                                Number(upcomingReservations.tax)
                            }}</span
                        >
                    </div>
                </div>
      ...
      <div class="flex items-center">
        ...
        <div class="flex flex-wrap gap-2">
          <div
            ...
            :class="{ 'bg-blue-500 text-white': selectedRooms.includes(room) }"
...
const total = computed(() => {
  return Number(props.upcomingReservations.price) + Number(props.upcomingReservations.tax);
});

const availableRooms = computed(() => {
  return JSON.parse(props.upcomingReservations.room.list).filter(
    (room) => props.upcomingReservations.booked_rooms==null ? true : !props.upcomingReservations.booked_rooms.includes(room)
  );
});
