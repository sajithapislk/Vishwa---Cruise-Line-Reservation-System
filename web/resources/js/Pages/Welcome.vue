...
<template>
    ...
    <header>
        <nav class="bg-gray-200 container mx-auto sm:px-4 px-3 flex justify-between items-center">
            <div class="nav--logo">
                <img src="https://www.tote-m.com/wp-content/uploads/2014/04/company-logo.jpg" width="150px" alt="">
            </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:hidden pt-0 lg:pt-0 bg-gray-200" id="nav-content">
                ...
                <div class="container mx-auto h-full sm:px-4 px-3">
                    <div class="flex mb-4 h-full items-center">
                        <div class="w-full lg:w-1/2 text-white font-roboto">
                            <h1 class="text-4xl  sm:text-5xl md:text-6xl font-bold tracking-wide leading-tight mb-12">The South Coast's leading port terminal operators</h1>
                            <p class="font-light text-lg">SCH is the most experienced stevedore in the Port of Southampton and our cargo operations are further enhanced by our
                        own dedicated warehouse close to the Port, providing secure storage supplemented by efficient stock management and
                        distribution.</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="section--latest-news w-full py-8 sm:my-8">
            <div class="container mx-auto px-3 sm:px-4 h-full">
                <div class="flex mb-4 h-full w-full flex-col sm:flex-row">
                    <div class="w-full md:w-7/12 section--latest-news__image h-full bg-cover relative bg-center">
                    </div>
                    <div class="w-full md:w-4/12 relative">
                       <a href="">
                           <div class="bg-white absolute bottom-0 left--4 shadow-full px-6 py-8 max-w-sm min-w-xl font-roboto scale-on-hover">
                                <h3 class="font-semibold text-main-blue text-lg mb-4 font-regular">LATEST NEWS</h3>
                                <h4 class="text-2xl font-semibold tracking-tight text-gray-900 mb-4">SUMMER OF CRUISE SHIP FIRSTS AT LIVERPOOL</h4>
                                <p class="text-gray-700">Stevedores and port terminal management specialists SCH have been awarded the contract for a further three years with
                                Liverpool City Council to handle all cruise ships calling at Liverpool Cruise Terminal (LCT).</p>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <section class="section--case-study w-full py-16 relative shadow-full">
            <div class="absolute h-full w-full top-0 left-0 bg-hero-gradient z-1">
                <div class="container mx-auto h-full w-full relative px-3 sm:px-4 ">
                    <a href="">
                        <div class="bg-white absolute  sm:bottom-0 mt-8 sm:mt-0  right-0 mx-3 sm:mx-0 px-6 py-8 max-w-xl min-w-xl font-roboto scale-on-hover">
                            <h3 class="font-semibold text-main-blue text-lg mb-4 font-regular">CASE STUDY</h3>
                            <h4 class="text-3xl font-semibold tracking-tight text-gray-900 mb-4">Warehouse peak season</h4>
                            <p class="text-gray-700 mb-4">Our expertise extends from receiving and managing cargo at the quayside to ship
...
.bg-hero-gradient {
    ...
    background: -webkit-linear-gradient(to right, rgba(2, 28, 121, 0.8), rgba(5, 118, 230, 0.5));  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, rgba(2, 28, 121, 0.8), rgba(5, 118, 230, 0.5)); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
