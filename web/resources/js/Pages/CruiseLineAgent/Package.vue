    ...
    <Modal :show="insertModal" @close="ModalFun">
        <div class="p-6">
            <form action="#">
                ...
                <div class="w-full px-3">
                    <ul>
                        <CheckBoxColor id="is_d" name="Dining" v-model:checked="saveform.is_d" />
                        <CheckBoxColor id="is_bl" name="Bars & Lounges" v-model:checked="saveform.is_bl" />
                        <CheckBoxColor id="is_en" name="Entertainment & Nightlife" v-model:checked="saveform.is_en" />
                        <CheckBoxColor id="is_c" name="Casino" v-model:checked="saveform.is_c" />
                        <CheckBoxColor id="is_ona" name="Onboard Activities" v-model:checked="saveform.is_ona" />
                        <CheckBoxColor id="is_outa" name="Outdoor Activities" v-model:checked="saveform.is_outa" />
                        <CheckBoxColor id="is_kt" name="Kids & Teens" v-model:checked="saveform.is_kt" />
                        <CheckBoxColor id="is_w" name="Wellness" v-model:checked="saveform.is_w" />
                        <CheckBoxColor id="is_s" name="Shopping" v-model:checked="saveform.is_s" />
                    </ul>
                </div>
